...
// Botão Buscar
document.getElementById("botaoBuscarEscuro")
.addEventListener("click", async () => {

    const origem = document.getElementById("inputPartidaEscuro").value;
    const destino = document.getElementById("inputChegadaEscuro").value;
